/* Vendorisé depuis node_modules/@capacitor/camera/dist/plugin.js (build
   "unpkg", conçu pour un usage <script> direct sans bundler) — copie
   verbatim, jamais modifiée à la main. Attend une variable globale
   "capacitorExports" avec au moins .registerPlugin et .WebPlugin — voir le
   petit shim juste avant ce <script> dans Planning_v1.0.html qui la
   fabrique à partir de window.Capacitor (déjà injecté nativement par
   Capacitor Android) ou d'un repli inoffensif sur le web normal (où
   Capacitor.Plugins.Camera doit rester absent). */
